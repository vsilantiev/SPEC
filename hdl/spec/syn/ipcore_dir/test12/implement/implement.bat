...
xst -ifn xst.scr
move test12_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\test12_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc test12_exdes.ucf test12_exdes

echo 'Running map'
map -timing -pr b test12_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm test12_exdes -w routed.ncd routed.v
cd ..
