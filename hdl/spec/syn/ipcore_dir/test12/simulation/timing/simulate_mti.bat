...
vlog -work work test12_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax test12_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.test12_tb work.glbl
