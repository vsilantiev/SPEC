...
vlog -work work test1_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax test1_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.test1_tb work.glbl
