...
xst -ifn xst.scr
move test1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\test1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc test1_exdes.ucf test1_exdes

echo 'Running map'
map -timing -pr b test1_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm test1_exdes -w routed.ncd routed.v
cd ..
